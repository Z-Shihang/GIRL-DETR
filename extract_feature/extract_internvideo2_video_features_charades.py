"""
Extract InternVideo2-L/14 video features for Charades-STA dataset.
...
Videos are sampled at 1 fps, then grouped into sliding windows of 8 frames
(stride=8, no overlap) to produce per-second features.

Requirements: torch, timm, einops, ffmpeg-python, numpy, tqdm

Usage:
    conda run -n video_lights python extract_feature/extract_internvideo2_video_features_charades.py --gpu 0
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract InternVideo2-L/14 video features for Charades-STA")
    ...
    parser.add_argument("--output_dir", type=str,
                        default="/data1/zhangshihang/Datasets/charades/internvideo2_video_features/",
                        help="Output directory for .npz feature files")
    parser.add_argument("--framerate", type=float, default=1.0,
                        help="Frame extraction rate (1.0 = 1 fps, matching existing features)")
